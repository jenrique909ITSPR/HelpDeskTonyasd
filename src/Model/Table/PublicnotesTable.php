 ...
 * @method \App\Model\Entity\Publicnote newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Publicnote[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Publicnote|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Publicnote patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Publicnote[] patchEntities($entities, array $data, array $options = [])
