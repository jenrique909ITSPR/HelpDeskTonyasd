...
<div class="ticketnotes form">
    ...
    <?= $this->Form->create($ticketnote) ?>
    		<table cellpadding="0" cellspacing="0" style="width:100%; border:none;">
						<tbody>
							<tr>
								<td  style="width:5%;"><?= $this->form->label(__('Ticket')) ?></td>
								<td colspan="3"><?= $this->Form->control('ticket_id', ['label' => false,'options' => $tickets, 'empty' => true]); ?>
								</td>
							</tr>
								<tr>
								...
								<tr>
									...
									<td  style="width:5%;">
										<?= $this->form->label(__('Ticketnotetypes')) ?>
									</td>
									<td>
										<?= $this->Form->control('ticketnotestype_id', ['label' => false,'options' => $ticketnotestypes]); ?>
									</td>
								</tr>
						</tbody>
				</table>
