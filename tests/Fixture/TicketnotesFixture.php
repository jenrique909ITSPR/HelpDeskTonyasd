 ...
 *
 */
class TicketnotesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ticketnotestype_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'ticket_id' => 1,
            'user_id' => 1,
            'created' => '2017-11-30 17:12:03',
            'ticketnotestype_id' => 1
        ],
    ];
}
